...
const professionals = [
  {
    ...
    firm: "Independent",
    location: "Sydney, NSW",
    services: ["ESG risk management", "Modern Slavery Act", "Supply chain due diligence", "GHG Protocol & PCAF", "ESG disclosure & reporting"],
    website: "#",
  },
  {
    name: "Maliha Marzan",
    title: "Sustainability & Impact Consultant",
    firm: "Independent",
    location: "Adelaide, SA",
    services: ["Stakeholder engagement", "Impact measurement", "ESG strategy", "Monitoring & evaluation", "Business development"],
    website: "https://www.linkedin.com/in/maliha-marzan",
  },
  {
    name: "Ali Raza",
    title: "Environmental & Sustainability Manager",
    firm: "NT Government / Independent",
    location: "Darwin, NT",
    services: ["Environmental impact assessment", "ISO 14001 auditing", "Environmental compliance", "EIA/ESIA", "Climate risk & scenario analysis"],
    website: "#",
  },
  {
    name: "Mohamed Akmal Akeel",
    title: "Sustainability Consultant",
    firm: "Super Smart Energy",
    location: "Melbourne, VIC",
    services: ["Scope 3 emissions", "AASB S2 / Climate disclosure", "GHG Protocol & ASRS", "Materiality assessments", "Decarbonisation strategy"],
    website: "https://www.linkedin.com/in/akmal-akeel-11a85a1b6/",
  },
  {
    name: "Manveer Singh",
    title: "Climate Change Coordinator",
    firm: "City of Adelaide",
    location: "Adelaide, SA",
    services: ["Climate change strategy", "GHG inventory reporting", "Carbon neutral programs", "Emissions reduction", "Stakeholder engagement"],
    website: "#",
  },
  {
    name: "Krishna Patel",
    title: "ESG & Environmental Consultant",
    firm: "Independent",
    location: "Adelaide, SA",
    services: ["GHG reporting & assurance", "Carbon accounting", "ISO 14064 & GRI", "Scope 1–3 emissions", "Compliance auditing"],
    website: "#",
  },
  {
    name: "Rishika Salvadi",
    title: "ESG & Sustainability Analyst",
    firm: "Independent",
    location: "Melbourne, VIC",
    services: ["ESG reporting (GRI, ISSB, ASRS, TCFD)", "Climate scenario analysis", "Circular economy", "ESG strategy", "Stakeholder engagement"],
    website: "https://www.linkedin.com/in/rishika-salvadi/",
  },
];
